...
#commmit check
 ...
 #downregulated is = low rate of change(less receptors)
 #upregulated is = high rate of change(more receptors)
 #In the biological context of organisms' production of gene products
